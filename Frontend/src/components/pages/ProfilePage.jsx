...
const ProfilePage = () => (
  <div className="flex-1 overflow-y-auto pb-20 md:pb-0">
    ...
    <div className="bg-neutral-900 text-neutral-100 p-12 md:p-20 text-center">
      <div className="w-28 h-28 md:w-40 md:h-40 bg-neutral-800 border-4 border-neutral-700 mx-auto mb-4 md:mb-6 flex items-center justify-center">
        <User size={56} className="md:w-24 md:h-24" strokeWidth={2.5} />
      </div>
      <h2 className="text-3xl md:text-5xl font-black mb-2 uppercase tracking-widest">Climber Name</h2>
